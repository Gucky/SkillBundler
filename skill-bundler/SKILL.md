---
name: "skill-bundler"
description: "Use when creating, reviewing, or maintaining a Skill Bundle: one visible top-level skill that routes to multiple hidden SUB_SKILL.md Sub-Skills using the root skill_bundle_template.md template and progressive-disclosure loading."
---
